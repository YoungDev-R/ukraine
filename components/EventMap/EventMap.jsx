...
export function EventMap({ controller = true }) {
	...
	useEffect(() => {
		const fetchData = async () => {
			Papa.parse('https://docs.google.com/spreadsheets/d/e/2PACX-1vQlf1UAZeg3GY4RiDeCRiGZVswlU3thtHDOeqlO_o0FvmsL635wXwDLx0_iJaPC0qP4eY3JlMfhjzzV/pub?output=csv', {
				header: true,
				download: true,
				dynamicTyping: true,
